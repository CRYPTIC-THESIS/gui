...
################################################################################
## Form generated from reading UI file 'mainScUwLT.ui'
##
...
"}")
        ...
        self.btn_all.setStyleSheet(u"")
        icon = QIcon()
        icon.addFile(u":/images/images/images/btnHome.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_all.setIcon(icon)
        self.btn_all.setIconSize(QSize(45, 45))

        self.verticalLayout_8.addWidget(self.btn_all)

        self.btn_btc_2 = QPushButton(self.cryptoButtons)
        self.btn_btc_2.setObjectName(u"btn_btc_2")
        self.btn_btc_2.setMinimumSize(QSize(0, 0))
        self.btn_btc_2.setStyleSheet(u"")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/images/btnBitcoin.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_btc_2.setIcon(icon1)
        self.btn_btc_2.setIconSize(QSize(45, 45))

        self.verticalLayout_8.addWidget(self.btn_btc_2)

        self.btn_eth_2 = QPushButton(self.cryptoButtons)
        self.btn_eth_2.setObjectName(u"btn_eth_2")
        self.btn_eth_2.setMinimumSize(QSize(0, 0))
        self.btn_eth_2.setStyleSheet(u"")
        icon2 = QIcon()
        icon2.addFile(u":/images/images/images/btnEthereum.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_eth_2.setIcon(icon2)
        self.btn_eth_2.setIconSize(QSize(45, 45))

        self.verticalLayout_8.addWidget(self.btn_eth_2)

        self.btn_doge_2 = QPushButton(self.cryptoButtons)
        self.btn_doge_2.setObjectName(u"btn_doge_2")
        self.btn_doge_2.setMinimumSize(QSize(0, 0))
        self.btn_doge_2.setStyleSheet(u"")
        icon3 = QIcon()
        icon3.addFile(u":/images/images/images/btnDogecoin.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_doge_2.setIcon(icon3)
        self.btn_doge_2.setIconSize(QSize(45, 45))

        self.verticalLayout_8.addWidget(self.btn_doge_2)
...
"font: 15px \"Segoe UI BOLD\";")
        ...
        self.home_dateToday.setStyleSheet(u"font: 30px \"Segoe UI BOLD\";\n"
"background: #2AB7CA;")
...
"border-top-left-radius: 10px;")
        ...
        self.frame_11.setMinimumSize(QSize(0, 41))
        ...
        self.frame_29.setStyleSheet(u"background: #2AB7CA;\n"
"border-radius:10px;")
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, MainWindow):
...
#if QT_CONFIG(tooltip)
        self.btn_all.setToolTip(QCoreApplication.translate("MainWindow", u"Home", None))
#endif // QT_CONFIG(tooltip)
        self.btn_all.setText("")
#if QT_CONFIG(tooltip)
        self.btn_btc_2.setToolTip(QCoreApplication.translate("MainWindow", u"Bitcoin", None))
#endif // QT_CONFIG(tooltip)
        self.btn_btc_2.setText("")
#if QT_CONFIG(tooltip)
        self.btn_eth_2.setToolTip(QCoreApplication.translate("MainWindow", u"Ethereum", None))
#endif // QT_CONFIG(tooltip)
        self.btn_eth_2.setText("")
#if QT_CONFIG(tooltip)
        self.btn_doge_2.setToolTip(QCoreApplication.translate("MainWindow", u"Dogecoin", None))
#endif // QT_CONFIG(tooltip)
        self.btn_doge_2.setText("")
#if QT_CONFIG(tooltip)
        ...
        self.home_daysValue.setText(QCoreApplication.translate("MainWindow", u"1", None))
#if QT_CONFIG(tooltip)
        ...
        self.crypto_daysValue.setText(QCoreApplication.translate("MainWindow", u"1", None))
#if QT_CONFIG(tooltip)
